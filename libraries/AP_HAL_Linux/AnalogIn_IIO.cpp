...
//    return _vcc_pin_analog_source->voltage_average() * 15;//5.67;
//    return _vcc_pin_analog_source->read_latest() * 5.67; // calibrate with V in / V divider
    return _vcc_pin_analog_source->read_average() * 5.67; // calibrate with V in / V divider
}
...
//    return _svr_pin_analog_source->voltage_average() * 12;//4.17;
//    return _svr_pin_analog_source->read_latest() * 4.17;
    return _svr_pin_analog_source->read_average() * 4.17;
}
