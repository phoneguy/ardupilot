...
void AP_Mount_SimpleServo::init(const AP_SerialManager& serial_manager)
{
    if (_instance == 0) {
...
void AP_Mount_SimpleServo::update()
{
...
void AP_Mount_SimpleServo::set_mode(enum MAV_MOUNT_MODE mode)
{
...
void AP_Mount_SimpleServo::check_servo_map()
{
...
void AP_Mount_SimpleServo::status_msg(mavlink_channel_t chan)
{
...
void AP_Mount_SimpleServo::stabilize()
{
...
int16_t AP_Mount_SimpleServo::closest_limit(int16_t angle, int16_t angle_min, int16_t angle_max)
{
...
void AP_Mount_SimpleServo::move_servo(uint8_t function_idx, int16_t angle, int16_t angle_min, int16_t angle_max)
{
