...
/*
  Super simple gimbal servo controlled mount backend class
 */

#ifndef __AP_MOUNT_SIMPLESERVO_H__
#define __AP_MOUNT_SIMPLESERVO_H__
...
class AP_Mount_SimpleServo : public AP_Mount_Backend
{
public:
    // Constructor
    AP_Mount_SimpleServo(AP_Mount &frontend, AP_Mount::mount_state &state, uint8_t instance):
...
#endif // __AP_MOUNT_SIMPLESERVO_H__
